...
--
-- Name: graphql; Type: SCHEMA; Schema: -; Owner: khulnasoft_admin
--

CREATE SCHEMA IF NOT EXISTS graphql;


ALTER SCHEMA graphql OWNER TO khulnasoft_admin;
...
--
-- Name: khulnasoft_functions; Type: SCHEMA; Schema: -; Owner: khulnasoft_admin
--

CREATE SCHEMA IF NOT EXISTS khulnasoft_functions;


ALTER SCHEMA khulnasoft_functions OWNER TO khulnasoft_admin;
...
--
-- Name: http_request(); Type: FUNCTION; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

CREATE OR REPLACE FUNCTION khulnasoft_functions.http_request() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'khulnasoft_functions'
    AS $$
  DECLARE
    request_id bigint;
    payload jsonb;
...
--
-- Name: hooks; Type: TABLE; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

CREATE TABLE IF NOT EXISTS khulnasoft_functions.hooks (
    id bigint NOT NULL,
...
--
-- Name: TABLE hooks; Type: COMMENT; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--
...
--
-- Name: hooks_id_seq; Type: SEQUENCE; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

CREATE SEQUENCE IF NOT EXISTS khulnasoft_functions.hooks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE khulnasoft_functions.hooks_id_seq OWNER TO khulnasoft_functions_admin;

--
-- Name: hooks_id_seq; Type: SEQUENCE OWNED BY; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

ALTER SEQUENCE khulnasoft_functions.hooks_id_seq OWNED BY khulnasoft_functions.hooks.id;


--
-- Name: migrations; Type: TABLE; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

CREATE TABLE IF NOT EXISTS khulnasoft_functions.migrations (
...
--
-- Name: hooks id; Type: DEFAULT; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

ALTER TABLE ONLY khulnasoft_functions.hooks ALTER COLUMN id SET DEFAULT nextval('khulnasoft_functions.hooks_id_seq'::regclass);
...
--
-- Data for Name: hooks; Type: TABLE DATA; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--



--
-- Data for Name: migrations; Type: TABLE DATA; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

INSERT INTO khulnasoft_functions.migrations (version, inserted_at) VALUES ('initial', '2023-03-16 02:25:30.966697+00');
INSERT INTO khulnasoft_functions.migrations (version, inserted_at) VALUES ('20210809183423_update_grants', '2023-03-16 02:25:30.966697+00');
...
--
-- Name: hooks_id_seq; Type: SEQUENCE SET; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

SELECT pg_catalog.setval('khulnasoft_functions.hooks_id_seq', 1, false);
...
--
-- Name: hooks hooks_pkey; Type: CONSTRAINT; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

ALTER TABLE ONLY khulnasoft_functions.hooks
    ADD CONSTRAINT hooks_pkey PRIMARY KEY (id);


--
-- Name: migrations migrations_pkey; Type: CONSTRAINT; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

ALTER TABLE ONLY khulnasoft_functions.migrations
...
--
-- Name: khulnasoft_functions_hooks_h_table_id_h_name_idx; Type: INDEX; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--
...
--
-- Name: khulnasoft_functions_hooks_request_id_idx; Type: INDEX; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--
...
GRANT USAGE ON SCHEMA net TO khulnasoft_functions_admin;
...
--
-- Name: SCHEMA khulnasoft_functions; Type: ACL; Schema: -; Owner: khulnasoft_admin
--

GRANT USAGE ON SCHEMA khulnasoft_functions TO postgres;
GRANT USAGE ON SCHEMA khulnasoft_functions TO anon;
GRANT USAGE ON SCHEMA khulnasoft_functions TO authenticated;
GRANT USAGE ON SCHEMA khulnasoft_functions TO service_role;
GRANT ALL ON SCHEMA khulnasoft_functions TO khulnasoft_functions_admin;
...
--
-- Name: FUNCTION comment_directive(comment_ text); Type: ACL; Schema: graphql; Owner: khulnasoft_admin
--
...
--
-- Name: FUNCTION exception(message text); Type: ACL; Schema: graphql; Owner: khulnasoft_admin
--
...
--
-- Name: FUNCTION get_schema_version(); Type: ACL; Schema: graphql; Owner: khulnasoft_admin
--
...
--
-- Name: FUNCTION increment_schema_version(); Type: ACL; Schema: graphql; Owner: khulnasoft_admin
--
...
--
-- Name: FUNCTION sequential_executor(prepared_statement_names text[]); Type: ACL; Schema: graphql; Owner: khulnasoft_admin
--
...
--
-- Name: FUNCTION graphql("operationName" text, query text, variables jsonb, extensions jsonb); Type: ACL; Schema: graphql_public; Owner: khulnasoft_admin
--
...
--
-- Name: FUNCTION http_collect_response(request_id bigint, async boolean); Type: ACL; Schema: net; Owner: khulnasoft_admin
--

REVOKE ALL ON FUNCTION net.http_collect_response(request_id bigint, async boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION net.http_collect_response(request_id bigint, async boolean) TO khulnasoft_functions_admin;
...
--
-- Name: FUNCTION http_get(url text, params jsonb, headers jsonb, timeout_milliseconds integer); Type: ACL; Schema: net; Owner: khulnasoft_admin
--

REVOKE ALL ON FUNCTION net.http_get(url text, params jsonb, headers jsonb, timeout_milliseconds integer) FROM PUBLIC;
GRANT ALL ON FUNCTION net.http_get(url text, params jsonb, headers jsonb, timeout_milliseconds integer) TO khulnasoft_functions_admin;
...
--
-- Name: FUNCTION http_post(url text, body jsonb, params jsonb, headers jsonb, timeout_milliseconds integer); Type: ACL; Schema: net; Owner: khulnasoft_admin
--

REVOKE ALL ON FUNCTION net.http_post(url text, body jsonb, params jsonb, headers jsonb, timeout_milliseconds integer) FROM PUBLIC;
GRANT ALL ON FUNCTION net.http_post(url text, body jsonb, params jsonb, headers jsonb, timeout_milliseconds integer) TO khulnasoft_functions_admin;
...
--
-- Name: FUNCTION http_request(); Type: ACL; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

REVOKE ALL ON FUNCTION khulnasoft_functions.http_request() FROM PUBLIC;
GRANT ALL ON FUNCTION khulnasoft_functions.http_request() TO postgres;
GRANT ALL ON FUNCTION khulnasoft_functions.http_request() TO anon;
GRANT ALL ON FUNCTION khulnasoft_functions.http_request() TO authenticated;
GRANT ALL ON FUNCTION khulnasoft_functions.http_request() TO service_role;
...
--
-- Name: SEQUENCE seq_schema_version; Type: ACL; Schema: graphql; Owner: khulnasoft_admin
--
...
--
-- Name: TABLE hooks; Type: ACL; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

GRANT ALL ON TABLE khulnasoft_functions.hooks TO postgres;
GRANT ALL ON TABLE khulnasoft_functions.hooks TO anon;
GRANT ALL ON TABLE khulnasoft_functions.hooks TO authenticated;
GRANT ALL ON TABLE khulnasoft_functions.hooks TO service_role;


--
-- Name: SEQUENCE hooks_id_seq; Type: ACL; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

GRANT ALL ON SEQUENCE khulnasoft_functions.hooks_id_seq TO postgres;
GRANT ALL ON SEQUENCE khulnasoft_functions.hooks_id_seq TO anon;
GRANT ALL ON SEQUENCE khulnasoft_functions.hooks_id_seq TO authenticated;
GRANT ALL ON SEQUENCE khulnasoft_functions.hooks_id_seq TO service_role;


--
-- Name: TABLE migrations; Type: ACL; Schema: khulnasoft_functions; Owner: khulnasoft_functions_admin
--

GRANT ALL ON TABLE khulnasoft_functions.migrations TO postgres;
GRANT ALL ON TABLE khulnasoft_functions.migrations TO anon;
GRANT ALL ON TABLE khulnasoft_functions.migrations TO authenticated;
GRANT ALL ON TABLE khulnasoft_functions.migrations TO service_role;
...
--
-- Name: DEFAULT PRIVILEGES FOR SEQUENCES; Type: DEFAULT ACL; Schema: graphql; Owner: khulnasoft_admin
--

ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA graphql GRANT ALL ON SEQUENCES  TO postgres;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA graphql GRANT ALL ON SEQUENCES  TO anon;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA graphql GRANT ALL ON SEQUENCES  TO authenticated;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA graphql GRANT ALL ON SEQUENCES  TO service_role;
...
--
-- Name: DEFAULT PRIVILEGES FOR FUNCTIONS; Type: DEFAULT ACL; Schema: graphql; Owner: khulnasoft_admin
--

ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA graphql GRANT ALL ON FUNCTIONS  TO postgres;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA graphql GRANT ALL ON FUNCTIONS  TO anon;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA graphql GRANT ALL ON FUNCTIONS  TO authenticated;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA graphql GRANT ALL ON FUNCTIONS  TO service_role;
...
--
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: graphql; Owner: khulnasoft_admin
--

ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA graphql GRANT ALL ON TABLES  TO postgres;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA graphql GRANT ALL ON TABLES  TO anon;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA graphql GRANT ALL ON TABLES  TO authenticated;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA graphql GRANT ALL ON TABLES  TO service_role;
...
--
-- Name: DEFAULT PRIVILEGES FOR SEQUENCES; Type: DEFAULT ACL; Schema: khulnasoft_functions; Owner: khulnasoft_admin
--

ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA khulnasoft_functions GRANT ALL ON SEQUENCES  TO postgres;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA khulnasoft_functions GRANT ALL ON SEQUENCES  TO anon;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA khulnasoft_functions GRANT ALL ON SEQUENCES  TO authenticated;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA khulnasoft_functions GRANT ALL ON SEQUENCES  TO service_role;


--
-- Name: DEFAULT PRIVILEGES FOR FUNCTIONS; Type: DEFAULT ACL; Schema: khulnasoft_functions; Owner: khulnasoft_admin
--

ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA khulnasoft_functions GRANT ALL ON FUNCTIONS  TO postgres;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA khulnasoft_functions GRANT ALL ON FUNCTIONS  TO anon;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA khulnasoft_functions GRANT ALL ON FUNCTIONS  TO authenticated;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA khulnasoft_functions GRANT ALL ON FUNCTIONS  TO service_role;


--
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: khulnasoft_functions; Owner: khulnasoft_admin
--

ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA khulnasoft_functions GRANT ALL ON TABLES  TO postgres;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA khulnasoft_functions GRANT ALL ON TABLES  TO anon;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA khulnasoft_functions GRANT ALL ON TABLES  TO authenticated;
ALTER DEFAULT PRIVILEGES FOR ROLE khulnasoft_admin IN SCHEMA khulnasoft_functions GRANT ALL ON TABLES  TO service_role;
