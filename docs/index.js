...
const createDownloadPage = async () => {
    const RequestOptions = {
        url: 'https://api.github.com/repos/khulnasoft/cli/releases/latest',
        headers: {
            'User-Agent': 'khulnasoft-cli-build',
        },
        json: true,
    };
    try {
        ...
        const finalContent =
            ...
            '+++\n' +
            '\n' +
            'Navigate to <a href="https://github.com/khulnasoft/cli/releases" target="_blank">Official Releases</a>\n' +
            'and download the binary that matches your operating system.<br>\n' +
            'We currently support the following OS: <br>\n' +
            '<ul>\n' +
                downloadLinks.map(({ label, downloadUrl = 'https://github.com/khulnasoft/cli/releases' }) =>
            ...
            '\n' +
            'If your operating system is missing please feel free to open us an issue in our <a href="https://github.com/khulnasoft/cli/issues" target="_blank">Github repository</a>.\n';
