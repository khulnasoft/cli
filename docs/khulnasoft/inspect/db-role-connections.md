...
This is a Khulnasoft specific command. You can see this breakdown on the dashboard as well:
https://app.khulnasoft.com/project/_/database/roles

The maximum number of active connections depends [on your instance size](https://khulnasoft.com/docs/guides/platform/compute-add-ons). You can [manually overwrite](https://khulnasoft.com/docs/guides/platform/performance#allowing-higher-number-of-connections) the allowed number of connection but it is not advised.
...
```
  ...
  ────────────────────────────┼───────────────────
    ...
    service_role              │                0
    dashboard_user            │                0
    khulnasoft_auth_admin       │                0
    khulnasoft_storage_admin    │                0
    khulnasoft_functions_admin  │                0
