...
Local migrations are stored in `khulnasoft/migrations` directory while remote migrations are tracked in `khulnasoft_migrations.schema_migrations` table. Only the timestamps are compared to identify any differences.
