...
Runs `pg_dump` in a container with additional flags to exclude Khulnasoft managed schemas. The ignored schemas include auth, storage, and those created by extensions.
