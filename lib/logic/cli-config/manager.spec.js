...
const { KHULNSOFT_PATH: mockKhulnasoftPath } = require('../../interface/cli/defaults');

const mockDirPath = path.resolve(mockKhulnasoftPath, 'cli-config');
