...
function builder(y) {
    ...
    return y
        ...
        .example('khulnasoft create workflow-data-item --workflow [WORKFLOW_ID] --file ./file.json', 'Create new Workflow-Data-Iten that belongs to WORKFLOW_ID with content from "./file.json"');
}
