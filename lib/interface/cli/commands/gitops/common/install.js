...
class GitopsInstaller {
    ...
    async install(argv) {
        ...
        const installOptions = _.pick(argv, ['git-integration', 'khulnasoft-integration', 'argo-token', 'output',
            'update', 'kube-context-name', 'kube-namespace', 'sync-mode', 'sync-apps', 'khulnasoft-host',
            'khulnasoft-token', 'khulnasoft-agent-suffix', 'in-cluster']);
