...
const command = new Command({
    ...
    builder: (yargs) => {
        ...
        return yargs
            ...
            .example('khulnasoft create team NAME', 'Creating a team specifying only team name')
            .example('khulnasoft create team NAME -f [pathToFile]', 'Creating a team using a file to specify additional options');
    },
    handler: async (argv) => {
