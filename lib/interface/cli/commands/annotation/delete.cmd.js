...
const command = new Command({
    ...
    builder: yargs => yargs
        ...
        .example('khulnasoft delete annotation image 2dfacdaad466 coverage tests_passed', 'Delete specified annotations')
        .example('khulnasoft delete annotation image 2dfacdaad466', 'Delete all annotations of entity'),
    handler: async (argv) => {
