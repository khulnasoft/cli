...
const command = new Command({
    ...
    builder: yargs => yargs
        ...
        .example('khulnasoft get annotation image 2dfacdaad466', 'Get all annotations for entity')
        .example('khulnasoft get annotation image 2dfacdaad466 coverage tests_passed', 'Get specified annotations'),
    handler: async (argv) => {
