...
const command = new Command({
    ...
    builder: (yargs) => yargs
        ...
        .example('khulnasoft create annotation image 2dfacdaad466 coverage=75%', 'Annotate entity with a single label')
        .example('khulnasoft create annotation image 2dfacdaad466 coverage=75% tests_passed=true', 'Annotate entity with multiple labels')
        // eslint-disable-next-line max-len
        .example('khulnasoft create annotation image 2dfacdaad466 coverage=75% tests_passed=true --display coverage', 'Annotate entity with multiple labels and display selection'),
    handler: async (argv) => {
