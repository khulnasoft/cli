require('debug')('khulnasoft:cli:delete:trigger');
...
const command = new Command({
    ...
    builder: (yargs) => {
        yargs
            ...
            .example('khulnasoft delete trigger registry:dockerhub:khulnasoft:fortune:push 5a439664af73ad0001f3ece0', 'Delete trigger by unlinking 5a43... pipeline from the DockerHub `khulnasoft/fortune` `push` event');
    },
    handler: async (argv) => {
