require('debug')('khulnasoft:cli:create:trigger');
...
const command = new Command({
    ...
    builder: (yargs) => {
        yargs
            ...
            .example('khulnasoft create trigger registry:dockerhub:khulnasoft:fortune:push 5a439664af73ad0001f3ece0', 'Create trigger by linking 5a43... pipeline to the DockerHub `khulnasoft/fortune` `push` event');
    },
    handler: async (argv) => {
