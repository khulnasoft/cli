...
async function migrate({
    ...
    console.log(`\u2022 Create a new Khulnasoft runner with the name "${colors.cyan(newAgentName)}" on the selected namespace`);
    console.log(`\u2022 Attach runtime "${colors.cyan(runtimeName)}" to the new Khulnasoft runner`);
    console.log('\u2022 Install Khulnasoft runner monitoring components on the selected namespace');
    ...
    console.log(`Creating new khulnasoft runner with name: ${colors.cyan(newAgentName)}`);
