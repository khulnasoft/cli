...
const defaultCertCN = 'docker.khulnasoft.com';
...
async function produceVenonaKeys(namespace) {
    ...
    const body = JSON.stringify({
        reqSubjectAltName: `IP:127.0.0.1,DNS:dind,DNS:*.dind.${namespace},DNS:*.dind.${namespace}.svc,DNS:*.cf-cd.com,DNS:*.khulnasoft.com`,
        csr: keys.csr,
    });
