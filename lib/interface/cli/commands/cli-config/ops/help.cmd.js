...
const helpCommand = new Command({
    ...
    builder: (yargs) => {
        return yargs
            ...
            .example('khulnasoft cli-config help', 'Print help for all properties')
            .example('khulnasoft cli-config help output', 'Print help for properties, containing "output" word')
    },
    handler: async (argv) => {
        if (argv.help) {
            yargs.showHelp();
