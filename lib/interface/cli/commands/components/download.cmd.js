...
const command = new Command({
    ...
    description: 'Download Khulnasoft CLI components',
    webDocs: {
        category: 'Components',
        title: 'Download',
    },
    builder: (yargs) => yargs
        ...
        .option('location', {
            describe: 'Override download folder location. Default: ~/.Khulnasoft',
        })
        .option('components', {
            describe: 'Components. List of [stevedore, venona, argocd-agent, khulnasoft]',
        }),
    handler: async (argv) => {
