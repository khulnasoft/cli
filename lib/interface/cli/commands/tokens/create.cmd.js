...
const command = new Command({
    command: 'token [name]',
    parent: createCmd,
    description: 'Generate Khulnasoft token',
    ...
    builder: (yargs) => {
        return yargs
            ...
            .example('khulnasoft create token some-token', 'Create token with default type')
            .example(
                'khulnasoft create token some-token --subject my-k8s-cluster/namespace --type runtime-environment',
