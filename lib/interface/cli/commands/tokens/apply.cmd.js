...
const command = new Command({
    ...
    aliases: ['token'],
    parent: applyCmd,
    description: 'Patch Khulnasoft token',
    ...
    builder: (yargs) => {
        yargs
            ...
            .example('khulnasoft patch token [token_id] --name new-name', 'Update token name')
            .example(
                'khulnasoft patch token [token_id] -s pipeline -s project',
