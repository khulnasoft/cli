...
const command = new Command({
    ...
    aliases: ['token'],
    parent: deleteCmd,
    description: 'Revoke Khulnasoft token',
    ...
    builder: (yargs) => {
        yargs
            ...
            .example('khulnasoft delete token [token_id]', 'Delete one token')
            .example('khulnasoft delete tokens [token_id_1] [token_id_2]', 'Delete many tokens');
    },
    handler: async (argv) => {
