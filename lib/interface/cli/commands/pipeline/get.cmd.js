const debug = require('debug')('khulnasoft:cli:create:pipelines2');
...
const command = new Command({
    ...
    builder: (yargs) => {
        return yargs
            ...
            .example('khulnasoft get pipeline --name PIPELINE_NAME', 'Get specific pipeline by it name')
            .example('khulnasoft get pip --label tags=tag1,tag2', 'Get list of pipelines by tag name');
    },
    handler: async (argv) => {
