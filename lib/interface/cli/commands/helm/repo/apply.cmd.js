...
const command = new Command({
    ...
    builder: (yargs) => {
        yargs
            ...
            .example('khulnasoft patch helm-repo my-repo -p', 'Update helm repo to be public')
            .example('khulnasoft patch helm-repo my-repo -p=false', 'Update helm repo to be private');
