...
const install = new Command({
    ...
    description: 'Install or upgrade a Helm chart Repository flag can be either absolute url or saved repository in Khulnasoft',
    webDocs: {
    ...
    builder: (yargs) => {
        return yargs
            ...
            .example('khulnasoft install-chart --name mongodb', 'Install chart from public helm repo')
            .example('khulnasoft get ctx --type helm-repository', 'Get all helm repos')
            .example('khulnasoft install-chart --name mongodb  --repository my-help-repository', 'Install chart saved repo');
    },
    handler: async (argv) => {
        try {
