...
const install = new Command({
    ...
    builder: (yargs) => {
        return yargs
            ...
            .example('khulnasoft set-helm-config cluster -v 2 -t pip1 -r pip2 -d pip3 --tiller-namespace kube-system', 'Helm2 config')
            .example('khulnasoft set-helm-config cluster -v 3 -t pip1 -r pip2 -d pip3 --release-namespaces ns1 --release-namespaces ns2', 'Helm3 config');
    },
    handler: async (argv) => {
        try {
