...
const command = new Command({
    ...
    builder: (yargs) => {
        yargs
            ...
            .example('khulnasoft delete section --board-name BOARD --name NAME', 'Delete section by board name and section name.')
            .example('khulnasoft delete section SECTION_ID', 'Delete section by id.');
        return yargs;
    },
    handler: async (argv) => {
