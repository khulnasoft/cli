...
const command = new Command({
    ...
    builder: (yargs) => {
        return yargs
            ...
            .example(
                'khulnasoft create section NAME --board-name BOARD_NAME --cluster CLUSTER_NAME',
                'Creating a section with board name',
            )
            .example(
                'khulnasoft create section NAME --board-id ID --cluster CLUSTER_NAME --color "#00AACC" --index 1',
