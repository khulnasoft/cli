...
const command = new Command({
    ...
    description: 'Analyzes your git repository and creates a proposed Khulnasoft pipeline that clones the source code and builds/packages it',
    webDocs: {
        category: 'Analyzer',
        title: 'Analyze'
    },
    builder: yargs => yargs
        ...
        .example('khulnasoft analyze elasticio petstore-component-nodejs github', 'Analyze repo'),
    handler: async (argv) => {
