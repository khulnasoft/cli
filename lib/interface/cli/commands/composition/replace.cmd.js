...
const command = new Command({
    ...
    builder: (yargs) => {
        ...
        return yargs
            ...
            .example('khulnasoft replace composition -f ./composition-spec.yml', 'Replace a composition using a spec file')
            .example('khulnasoft replace composition NAME --compose-file ./docker-compose.yml -v key1=value1 -v key2=value2', 'Replace a composition using options');
    },
    handler: async (argv) => {
