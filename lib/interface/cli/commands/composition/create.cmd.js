...
const command = new Command({
    ...
    builder: (yargs) => {
        ...
        return yargs
            ...
            .example('khulnasoft create composition NAME --compose-file ./docker-compose.yml', 'Creating a composition using a docker-compose.yml file')
            .example('khulnasoft create composition NAME --compose-file ./docker-compose.yml -v key1=value1 -v key2=value2', 'Defining composition variables');
