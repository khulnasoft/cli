    ...
    describe('auth', () => {
        describe('printTableForAuthContexts', () => {
            ...
            it('should log fallback message when no current context and no sdk context', async () => {
                ...
                expect(console.log).toBeCalledWith('No authentication contexts. Please create an authentication context (see khulnasoft auth create-context --help)'); // eslint-disable-line
