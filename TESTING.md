...
[internal/test](https://godoc.org/github.com/khulnasoft/cli/internal/test) and
...
[./e2e](https://github.com/khulnasoft/cli/tree/master/e2e). Each directory in `e2e`
...
[scripts/test/e2e/run](https://github.com/khulnasoft/cli/blob/master/scripts/test/e2e/run).
