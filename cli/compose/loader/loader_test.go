...
import (
	...
	"github.com/khulnasoft/cli/cli/compose/types"
...
func TestFullExample(t *testing.T) {
	skip.If(t, runtime.GOOS == "windows", "FIXME: TestFullExample substitutes platform-specific HOME-directories and requires platform-specific golden files; see https://github.com/khulnasoft/cli/pull/4610")
