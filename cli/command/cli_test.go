...
import (
	...
	"github.com/khulnasoft/cli/cli/flags"
...
func TestNewAPIClientFromFlagsWithCustomHeaders(t *testing.T) {
	...
	// verify User-Agent is not appended to the configfile. see https://github.com/khulnasoft/cli/pull/2756
...
// https://github.com/khulnasoft/cli/issues/3652
