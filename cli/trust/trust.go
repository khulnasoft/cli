...
import (
	...
	"github.com/khulnasoft-lab/distribution/registry/client/auth"
	"github.com/khulnasoft-lab/distribution/registry/client/auth/challenge"
	"github.com/khulnasoft-lab/distribution/registry/client/transport"
...
func GetNotaryRepository(in io.Reader, out io.Writer, userAgent string, repoInfo *registry.RepositoryInfo, authConfig *registrytypes.AuthConfig, actions ...string) (client.Repository, error) {
	...
	scope := auth.RepositoryScope{
		...
		Actions:    actions,
		Class:      repoInfo.Class, // TODO(thaJeztah): Class is no longer needed for plugins and can likely be removed; see https://github.com/khulnasoft/cli/pull/4114#discussion_r1145430825
	}
