...
import (
	...
	"github.com/khulnasoft/cli/internal/restrictions/get"
	"github.com/khulnasoft/cli/internal/restrictions/update"
...
func init() {
	restrictionsCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Khulnasoft project.")
