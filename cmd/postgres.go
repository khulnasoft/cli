...
import (
	...
	"github.com/khulnasoft/cli/internal/postgresConfig/get"
	"github.com/khulnasoft/cli/internal/postgresConfig/update"
...
func init() {
	postgresCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Khulnasoft project.")
