...
import (
	...
	"github.com/khulnasoft/cli/internal/hostnames/activate"
	"github.com/khulnasoft/cli/internal/hostnames/create"
	"github.com/khulnasoft/cli/internal/hostnames/delete"
	"github.com/khulnasoft/cli/internal/hostnames/get"
	"github.com/khulnasoft/cli/internal/hostnames/reverify"
...
var (
	customHostnamesCmd = &cobra.Command{
		...
		Use:     "domains",
		Short:   "Manage custom domain names for Khulnasoft projects",
		Long: `Manage custom domain names for Khulnasoft projects.
...
`,
	...
	customHostnamesCreateCmd = &cobra.Command{
		...
		Long: `Create a custom hostname for your Khulnasoft project.

Expects your custom hostname to have a CNAME record to your Khulnasoft project's subdomain.`,
	...
	customHostnamesGetCmd = &cobra.Command{
		...
		Long:  "Retrieve the custom hostname config for your project, as stored in the Khulnasoft platform.",
		RunE: func(cmd *cobra.Command, args []string) error {
...
This reconfigures your Khulnasoft project to respond to requests on your custom hostname.
After the custom hostname is activated, your project's auth services will no longer function on the Khulnasoft-provisioned subdomain.`,
		RunE: func(cmd *cobra.Command, args []string) error {
...
func init() {
	...
	customHostnamesCreateCmd.Flags().StringVar(&customHostname, "custom-hostname", "", "The custom hostname to use for your Khulnasoft project.")
